...
2. Last så ned integrasjonspunkt-local.properties filen. den kan lastes ned <a href="https://github.com/difi/move-integrasjonspunkt/blob/gh-pages/resources/integrasjonspunkt_local.properties" download> og lagre i overnevnte mappe <br>
